...
export function Footer() {
  const socialLinks = [
    ...
    {
      Icon: FaInstagram,
      href: "https://www.instagram.com/inclusion_bridge_africa?igsh=M2ZmM3c5dXRxd3My",
      label: "Instagram",
    },
    {
      Icon: FaLinkedin,
    ...
    {
      Icon: FaTiktok,
      href: "https://www.tiktok.com/@Inclusion.bridge",
      label: "TikTok",
    },
  ];
    ...
    <footer className="bg-primary text-white pt-16 pb-8">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-primary-foreground/80 leading-relaxed">
              Empowering persons with disabilities through advocacy, training,
              and community. Building a world where everyone belongs.
            </p>
          ...
          <div>
            ...
            <p className="text-primary-foreground/80 mb-4 text-sm">
              Join our newsletter for updates on our latest programs and
              stories.
            </p>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-primary-foreground/60">
          <p>
            © {new Date().getFullYear()} Inclusion Bridge Africa. All rights
            reserved.
          </p>
